...
4. **State‑dependent feedback** – the phase kick acts as a “self‑interaction” that can either stabilise or destabilise the orbit, depending on the base parameter $$\(c\)$$ and the kick strength $$\(\alpha\)$$.
